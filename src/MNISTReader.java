...
public class MNISTReader {
    ...
    public static void readNumbersImages(String labelsFile, String imagesFile,
                                         float[] x, float[] t, int n) throws IOException {
        ...
        if (numLabels != numImages) {
            ...
            System.exit(0);
        } /*else if (numImages * numRows * numCols != x.length) {
            System.err.println("Image files and x array have not correct sizes");
            System.exit(0);
        } else if (numLabels * 10 != t.length) {
            System.err.println("Image labels and t array have not correct sizes");
            System.exit(0);
        }*/
